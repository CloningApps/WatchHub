...
import { Home, Trending, Users, Library, History, PlaySquare, Clock, ThumbsUp, Menu, Search, User } from "lucide-react"
  ...
  return (
    <div className="flex flex-col h-screen">
      ...
      <header className="flex items-center justify-between p-4 border-b">
        ...
        <Avatar>
          <AvatarImage src={`${process.env.PUBLIC_URL}/placeholder.svg?height=32&width=32`} alt="User" />
            ...
            {[...Array(12)].map((_, i) => (
              <div key={i} className="space-y-2">
                <div className="aspect-video bg-muted rounded-lg overflow-hidden">
                  <img
                    src={`${process.env.PUBLIC_URL}/placeholder.svg?height=180&width=320&text=Video+${i + 1}`}
                ...
                <div className="flex space-x-2">
                  <Avatar className="w-8 h-8">
                    <AvatarImage src={`${process.env.PUBLIC_URL}/placeholder.svg?height=32&width=32`} alt="Channel" />
